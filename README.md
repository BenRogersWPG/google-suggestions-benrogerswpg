...
```bash
npm run build
npm install google-suggestions-benrogerswpg
```

## Import

```js
import getGoogleSuggestions from 'google-suggestions-benrogerswpg'; // ES module

const getGoogleSuggestions = require('google-suggestions-benrogerswpg'); // commonJS
```
